...
You can find the latest version under [releases]([url](https://github.com/roadsidebomb/Polybar-Minibar-3D-Print-Files/releases)). The download includes all STL, F3D and PCB files for use under the license listed below.</p>
